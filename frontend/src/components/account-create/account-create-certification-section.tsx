...
/**
 * AccountCreateCertificationSection コンポーネントの Props 定義
 */
type AccountCreateCertificationSectionProps = {
 ...
 *
 * @param props - {@link AccountCreateCertificationSectionProps}
 * @returns 保有資格のタグ表示・追加（AutocompleteSelect）・削除を行う UI
 */
export const AccountCreateCertificationSection = ({
  form,
  certificationsMast = [],
}: AccountCreateCertificationSectionProps) => {
